...
const InstituteMappingContext = createContext<InstituteMappingContextValue | undefined>(undefined);
...
export function InstituteMappingProvider({ facilityId, children }: InstituteMappingProviderProps) {
...
export function useInstituteMapping() {
    ...
    if (context === undefined) {
        throw new Error("useInstituteMapping must be used within InstituteMappingProvider");
    }
    return context;
}
